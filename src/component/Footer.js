...
<footer class="text-gray-600 body-font bg-gray-100">
  <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
      <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900" href='/'>
        <img alt='' src={logo} className='footrerlogo'/>
        <span class="ml-3 text-xl">Mathematics</span>
      </a>
      <p class="mt-2 text-sm text-gray-500">Pure mathematics is, in its way, the poetry of logical ideas... </p>
    </div>
  ...
  <div class="bg-gray-100">
    <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p class="text-gray-500 text-sm text-center sm:text-left">© 2024 ctgcollegemath —
        <a href="https://www.facebook.com/muntasir.ahmed.169/" rel="noopener noreferrer" class="text-gray-600 ml-1" target="_blank">@mahafuz</a>
      </p>
